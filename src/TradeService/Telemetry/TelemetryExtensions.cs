...
namespace TradeService.Telemetry;
...
{
    public const string ServiceName = "TradeService";
    public const string ServiceVersion = "1.0.0";
    
    // Custom ActivitySource for manual instrumentation (Oracle DB operations)
        ...
        services.AddOpenTelemetry()
            .WithTracing(builder =>
            {
                builder
                    ...
                    // OpenTelemetry automatically picks up Azure.* activities
                    .AddSource("Azure.*")
                    // Npgsql has built-in OpenTelemetry support
                    .AddSource("Npgsql")
                    // Our custom ActivitySource for additional context
